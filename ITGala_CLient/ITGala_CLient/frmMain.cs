...
namespace ITGala_CLient
{
    public partial class frmMain : Form
    {
        ...
        private void Phanthitangtoc()
        {
            try
            {
                lblPhanthi.Text = "PHẦN THI: FINISH";
                phanthi = "TANGTOC";
        ...
        private void StartTT(string msg)
        {
            ...
            if (msg != " ")
            {
                ...
                {
                    lblCauhoi.Text = "ĐÃ HOÀN THÀNH PHẦN THI";
                }
            }
        ...
        private void StartVD(string msg)
        {
            ...
            {
                lblCauhoi.Text = "ĐÃ HOÀN THÀNH CÁC CÂU HỎI PHẦN THI NÀY";
            }
        }
